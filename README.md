...
I build local-first tools, automation systems, and reliable workflows for AI agents.

Guangzhou, China

<p>
  <a href="https://bobochang.cn"><img src="https://img.shields.io/badge/Website-bobochang.cn-18181b?style=flat-square" alt="Website: bobochang.cn"></a>
  <a href="https://github.com/can4hou6joeng4/boss-agent-cli"><img src="https://img.shields.io/badge/Featured-boss--agent--cli-2563eb?style=flat-square&amp;logo=github&amp;logoColor=white" alt="Featured project: boss-agent-cli"></a>
  <a href="https://bobochang.cn/writing/unicode-braille-8-pixel-bitmap-font/"><img src="https://img.shields.io/badge/Writing-Unicode_Braille-7c3aed?style=flat-square" alt="Writing: Unicode braille is an 8-pixel bitmap font"></a>
  <a href="https://relay.bobochang.cn"><img src="https://img.shields.io/badge/Agent_handoff-Watch-059669?style=flat-square" alt="Agent handoff: Watch"></a>
</p>
...
### [Unicode braille is an 8-pixel bitmap font](https://bobochang.cn/writing/unicode-braille-8-pixel-bitmap-font/)

An implementation-focused look at treating each braille character as a 2×4 bitmap, then using Floyd–Steinberg error diffusion to preserve image detail as plain text. The working browser implementation is available in [Semaphore](https://semaphore.bobochang.cn).

## Engineering Principles

- Define system and responsibility boundaries explicitly.
- Keep sensitive data local wherever practical.
- Make automation observable, inspectable, and verifiable.
- Prefer reversible actions and low-risk defaults.

Repository names follow **one word, one image, one emoji**. Names carry identity; descriptions explain function.
